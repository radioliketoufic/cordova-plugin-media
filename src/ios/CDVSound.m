    ...
    if ((audioFile != nil) && (audioFile.resourceURL != nil)) {
        ...
        if (!bError) {
            ...
            if ([self hasAudioSession]) {
                ...
                [self.avSession setCategory:sessionCategory withOptions:AVAudioSessionCategoryOptionMixWithOthers|AVAudio​Session​Category​Option​Allow​Bluetooth|AVAudioSessionCategoryOptionDefaultToSpeaker error:&err];
                ...
                void (^startRecording)(void) = ^{
                    ...
                    if ([weakSelf hasAudioSession]) {
                        if (![weakSelf.avSession.category isEqualToString:AVAudioSessionCategoryPlayAndRecord]) {
                            ...
                            [weakSelf.avSession setCategory:AVAudioSessionCategoryPlayAndRecord withOptions:AVAudioSessionCategoryOptionMixWithOthers|AVAudio​Session​Category​Option​Allow​Bluetooth|AVAudioSessionCategoryOptionDefaultToSpeaker error:nil];
